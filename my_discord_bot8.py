...
# Konfiguration
DISCORD_BOT_TOKEN = 'MTMzMjI3OTc5MzkzMjA0MjI0MA.GG9Yql.o22iClg7ZKnDcdS4RSE5iCHdVj_QHT6RNTnfVo'  # Erstat med din bot token
DISCORD_CHANNEL_ID = 123456789012345678  # Erstat med din Discord-kanal ID
BATTLEMETRICS_API_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbiI6ImQ2ZjNkOTU0MzA1MTgyNmMiLCJpYXQiOjE3Mzc3MTE3MTEsIm5iZiI6MTczNzcxMTcxMSwiaXNzIjoiaHR0cHM6Ly93d3cuYmF0dGxlbWV0cmljcy5jb20iLCJzdWIiOiJ1cm46dXNlcjo2NjUxNzkifQ.K5r7Scg0ZoREaIZgRGT2ks1r5rXHhotMpoxgNyxG-tQ'  # Erstat med din Battlemetrics API key
...
async def check_servers():
    ...
    while not bot.is_closed():
        for server_id in servers_to_monitor:
            url = f'https://api.battlemetrics.com/servers/{server_id}/players'  # Hent spillere fra serveren
                        ...
                        if 'data' in data:
                            ...
                            if players_data:  # Tjek om players_data ikke er tom
                                current_players = set(
                                    ...
                                    if 'attributes' in player and 'name' in player['attributes']
                                    and player['attributes']['name'] in whitelisted_players
                                )
